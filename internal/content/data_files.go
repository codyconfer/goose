	...
	"data/balance.json": `
{
  ...
  "price_trend_turbulence": 1.35,
  "price_trend_reversion_drag": 1.15,
  "price_cashflow_trend": 0.02,
  "price_trade_trend": 0.03,
  "price_derivative_trend": 0.035,
  "price_floor": 0.4,
  "price_ceil": 2.0,
  ...
  "spec_unlock_level": 4,
  "spec_expiry_seconds": 60,
  "spec_margin_penalty": 0.4,
  "spec_maintenance_margin": 0.35,
  "spec_leverages": [1, 2, 5, 10, 20, 50],
  "spec_premiums": [50, 250, 1000, 5000, 25000, 100000],
	...
	"data/text.json": `
{
  ...
  "trade": {
    ...
    "trend_up_fmt": "▲ %.0f%%",
    "trend_down_fmt": "▼ %.0f%%",
    "trend_label": "trend engine",
    "trend_strength_label": "momentum",
    "trend_bull_fmt": "bullish %.0f%%",
    "trend_bear_fmt": "bearish %.0f%%",
    "trend_sideways": "sideways chop",
    "now_prefix": "now ",
  ...
  "spec": {
    ...
    "liq_price_label": "liq. price",
    "buffer_label": "maintenance buffer",
